...
export default function AddonsLayout({ children }: { children: React.ReactNode }) {
  ...
  const basePath = `/events/${eventId}/addons`
  ...
  const isActive = (href: string) => {
    ...
    if (href === "") {
      // Check if we're on the base path or the participants subpage
      return pathname === basePath || pathname.match(/\/addons\/[^/]+\/participants$/)
    }
        ...
        <div className="px-4 py-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Manage event add-ons</p>
            </div>
          </div>
          {/* Event Info */}
          {event && (
        ...
        <div className="p-3 border-t">
          <div className="bg-secondary/50 rounded-lg p-3">
            <p className="text-xs text-muted-foreground">
              <strong>Tip:</strong> Add-ons like workshops, meals, or merchandise can increase event revenue and enhance attendee experience.
            </p>
          </div>
        </div>
      </div>
        ...
        return (
          <>
            ...
            <div className={cn(
              ...
              <div className="px-4 pb-2 font-semibold text-lg border-b">Add-ons</div>
