    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 p-5 hover:shadow-lg hover:shadow-blue-500/10 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-4xl font-bold text-blue-600 dark:text-blue-400">{stats.totalReviews}</p>
        ...
        <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 p-5 hover:shadow-lg hover:shadow-purple-500/10 transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-4xl font-bold text-purple-600 dark:text-purple-400">{stats.avgReviews}</p>
                  ...
                  {reviewer.activity && (
                    <div className="flex items-center gap-2">
                      ...
                      <div
                        className={cn(
                          ...
                          reviewer.activity.assignments_opened > 0
                            ...
                            : "bg-gray-100 dark:bg-muted/60 text-gray-500 dark:text-muted-foreground"
                        )}
                      ...
                      {reviewer.activity.reminders_sent > 0 && (
                        <div
                          className="flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium bg-amber-100 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400"
                      ...
                      <div
                        className={cn(
                          "flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium",
                          reviewer.activity.activity_status === "active_today" && "bg-emerald-100 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-400",
                          reviewer.activity.activity_status === "active_recently" && "bg-blue-100 dark:bg-blue-500/15 text-blue-700 dark:text-blue-400",
                          reviewer.activity.activity_status === "inactive_week" && "bg-amber-100 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400",
                          reviewer.activity.activity_status === "inactive_long" && "bg-red-100 dark:bg-red-500/15 text-red-700 dark:text-red-400",
                          reviewer.activity.activity_status === "never_active" && "bg-gray-100 dark:bg-muted/60 text-gray-500 dark:text-muted-foreground"
                        )}
                        title={
                      ...
                      {reviewer.activity.assignments_declined > 0 && (
                        <div
                          className="flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium bg-red-100 dark:bg-red-500/15 text-red-700 dark:text-red-400"
              ...
              <div className="space-y-5">
                <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-blue-900 dark:text-blue-300">New Reviewer</p>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    editForm.status === "inactive"
                      ? "bg-gray-500/10 border-gray-500/30 text-gray-700 dark:text-muted-foreground"
                      : "border-muted hover:border-muted-foreground/20"
                  )}
                >
