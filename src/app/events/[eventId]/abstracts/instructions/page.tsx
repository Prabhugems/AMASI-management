    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="bg-card border rounded-xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-500/10 rounded-lg">
          ...
          <div className="flex items-start gap-4 p-4 bg-green-50 dark:bg-green-500/10 rounded-lg">
          ...
          <div className="flex items-start gap-4 p-4 bg-purple-50 dark:bg-purple-500/10 rounded-lg">
