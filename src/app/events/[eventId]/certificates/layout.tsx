...
export default function CertificatesLayout({ children }: { children: React.ReactNode }) {
  ...
  const { data: userPermissions, isLoading: permissionsLoading } = useQuery({
    queryKey: ["user-permissions", eventId, "certificates"],
    queryFn: async () => {
      ...
      return {
        ...
        isTeamUser,
        hasFullAccess,
        hasAccess: isAdmin || hasFullAccess || hasCertificatesPermission,
        userName: teamMember.name || session.user.email,
      }
    },
    staleTime: 0,
    ...
    return (
      <div className="flex h-[calc(100vh-6rem)] items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">You don't have permission to access Certificates.</p>
        ...
        <div className="flex flex-1 overflow-hidden">
          <div className="w-56 border-r bg-muted/30 flex flex-col">
            ...
            <div className="px-4 py-3 border-b">
              ...
              <p className="text-xs text-muted-foreground">Design & send certificates</p>
            </div>
            ...
            {!permissionsLoading && !userPermissions?.hasFullAccess && (
              <div className="p-3 border-t">
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  <FileText className="h-3 w-3" /><span>Certificates Access</span>
                </div>
              </div>
            )}
          </div>
        ...
        return (
          <>
            ...
            <div className={cn(
              ...
              <div className="px-4 pb-2 font-semibold text-lg border-b">Certificates</div>
