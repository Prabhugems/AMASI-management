    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 p-8 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-3xl text-white font-bold text-2xl hover:shadow-lg hover:shadow-purple-500/30 transition-all mb-8"
        >
