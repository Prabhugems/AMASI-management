    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-white/70 mt-4">Verifying...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-900 to-red-800 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            {result?.error || "This could not be verified. It may be invalid or expired."}
          </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-emerald-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 p-6 text-white text-center">
          ...
          <h1 className="text-xl font-bold">Verified Registration</h1>
          <p className="text-emerald-100 text-sm mt-1">This registration has been authenticated</p>
        </div>
        ...
        <div className="bg-gray-50 px-6 py-4 text-center">
          <p className="text-xs text-gray-500">
            This registration has been verified. For check-in, present this at the registration desk.
          </p>
        </div>
      </div>
    </div>
