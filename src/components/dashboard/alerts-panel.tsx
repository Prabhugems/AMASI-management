...
const initialAlerts: Alert[] = [
  {
    ...
    description: "Conference 2026 - Invitations sent 7+ days ago. Follow up required to confirm participation.",
  ...
  },
  {
    ...
    description: "Conference 2026 - Confirm remaining 15 rooms or they will be released.",
