#!/usr/bin/env node
/**
 * Send technosurg_welcome WhatsApp + email to the 43 Sun Pharma comp delegates
 * inserted 2026-06-17 (TECHNO SURG - SUN PHARMA(17-06.2026).xlsx).
 * Dry-run by default; pass --live to actually send.
 */
...
const TARGET_REG_NUMBERS = [
  "REG-20260617-W0HYGHI", "REG-20260617-ESKDHGK", "REG-20260617-NBL0VOB",
  "REG-20260617-MGPMMHS", "REG-20260617-37BNFP6", "REG-20260617-NKIGIIZ",
  "REG-20260617-Q9PMMSD", "REG-20260617-GIA2ICV", "REG-20260617-AZ7CEDD",
  "REG-20260617-6P8H7EI", "REG-20260617-IIMBYI8", "REG-20260617-E5OY5HU",
  "REG-20260617-0MDTC6C", "REG-20260617-O750VH1", "REG-20260617-NGSXMF0",
  "REG-20260617-4D1I06A", "REG-20260617-GDQA1ZR", "REG-20260617-FOPJFP2",
  "REG-20260617-1DB8SOS", "REG-20260617-KBZ38UX", "REG-20260617-U3QMBT7",
  "REG-20260617-PZ61E0N", "REG-20260617-BEDQ0IK", "REG-20260617-W88K3A4",
  "REG-20260617-KS4OXLO", "REG-20260617-XAR7MQL", "REG-20260617-F1FX6WI",
  "REG-20260617-7DEVD29", "REG-20260617-4DREADW", "REG-20260617-J4HFP5I",
  "REG-20260617-0GKHI0Z", "REG-20260617-ZJYKXXD", "REG-20260617-434C6IV",
  "REG-20260617-ZDBZ2BE", "REG-20260617-ZSQ2YRO", "REG-20260617-99C7154",
  "REG-20260617-O6DYJM8", "REG-20260617-EGEQDUE", "REG-20260617-DQJCFNC",
  "REG-20260617-H5VQIG3", "REG-20260617-FOVGHV7", "REG-20260617-D7UZRWP",
  "REG-20260617-0NR6FMA",
]
...
console.log(`Matched: ${regs.length} of ${TARGET_REG_NUMBERS.length}\n`)

const matched = new Set(regs.map(r => r.registration_number))
for (const n of TARGET_REG_NUMBERS) if (!matched.has(n)) console.log(`  ! not found: ${n}`)
