#!/usr/bin/env node
/**
 * Send technosurg_welcome WhatsApp + email to the 7 comp delegates created
 * 2026-06-17 (from DOC-20260615-WA0000..xlsx).
 *
...
const TARGET_REG_NUMBERS = [
  "REG-20260617-Y8RO9QX", // Pravindhira S.N.
  "REG-20260617-R0EKUVB", // Kishore.D
  "REG-20260617-YEMUMAI", // Gopi Ramu
  "REG-20260617-LQGIFNM", // Archana H
  "REG-20260617-9UHNM4C", // Irshad Ahamed S
  "REG-20260617-030MMGX", // Vijayan
  "REG-20260617-1CDB3S3", // Archit Pathak
]
