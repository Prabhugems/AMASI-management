#!/usr/bin/env node
/**
 * Send technosurg_welcome WhatsApp + email to the 5 med college HOD comp delegates
 * added 2026-06-18. Targets by phone since they're stored with placeholder emails.
...
const TARGET_PHONES = [
  "9840532487", // C. Sugumar
  "9444357682", // Jeswanth
  "9500034959", // L. Anand
  "9360301535", // Prabhakaran
  "9841229807", // Amudhan
]
...
const { data: regs } = await db
  ...
  .in("attendee_phone", TARGET_PHONES)
  .order("registration_number", { ascending: true })

console.log(`Event: ${eventName}`)
console.log(`Mode:  ${LIVE ? "LIVE" : "DRY RUN"}`)
console.log(`Target phones: ${TARGET_PHONES.length}`)
