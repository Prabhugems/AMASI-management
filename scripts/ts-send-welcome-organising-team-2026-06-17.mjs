#!/usr/bin/env node
/**
 * Send technosurg_welcome WhatsApp + email to every TechnoSurg Organising Team
 * member (registration_number LIKE 'TECH-O-%'). Dry-run by default; pass --live.
 */
...
const { data: regs } = await db
  ...
  .ilike("registration_number", "TECH-O-%")
